###########################################################################
## Makefile generated for component 'flexibleDrive_NotchLeadLag'. 
## 
## Makefile     : flexibleDrive_NotchLeadLag.mk
## Generated on : Mon Nov 24 12:08:45 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\flexibleDrive_NotchLeadLag.rt-win64
...
PRODUCT_NAME              = flexibleDrive_NotchLeadLag
MAKEFILE                  = flexibleDrive_NotchLeadLag.mk
...
COMPILER_COMMAND_FILE     = flexibleDrive_NotchLeadLag_comp.rsp
CMD_FILE                  = flexibleDrive_NotchLeadLag.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\flexibleDrive_NotchLeadLag.rt-win64
...
DEFINES_STANDARD = -DMODEL=flexibleDrive_NotchLeadLag -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag.c $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_data.c $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_main.c $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetInf.c $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetNaN.c $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = flexibleDrive_NotchLeadLag.obj flexibleDrive_NotchLeadLag_data.obj flexibleDrive_NotchLeadLag_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
flexibleDrive_NotchLeadLag.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag.c


flexibleDrive_NotchLeadLag_data.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_data.c


flexibleDrive_NotchLeadLag_main.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\flexibleDrive_NotchLeadLag_main.c


rtGetInf.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\flexibleDrive_NotchLeadLag_quarc_win64\rt_nonfinite.c
