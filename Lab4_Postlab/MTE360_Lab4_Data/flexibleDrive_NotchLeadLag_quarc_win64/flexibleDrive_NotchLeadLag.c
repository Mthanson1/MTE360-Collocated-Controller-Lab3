...
void flexibleDrive_NotchLeadLag_output(void)
{
   ...
   *  Sum: '<Root>/Sum'
   */
  flexibleDrive_NotchLeadLag_B.Gain = (flexibleDrive_NotchLeadLag_B.Output -
    flexibleDrive_NotchLeadLag_B.InverseModulus1) *
  ...
  flexibleDrive_NotchLeadLag_B.LeadComp3 = 0.0;
  flexibleDrive_NotchLeadLag_B.LeadComp3 +=
    flexibleDrive_NotchLeadLag_P.LeadComp3_C *
    flexibleDrive_NotchLeadLag_X.LeadComp3_CSTATE;
  flexibleDrive_NotchLeadLag_B.LeadComp3 +=
    flexibleDrive_NotchLeadLag_P.LeadComp3_D *
    flexibleDrive_NotchLeadLag_B.LeadComp2;

  /* TransferFcn: '<Root>/Notch Filter1' */
  rtb_NotchFilter1 = (flexibleDrive_NotchLeadLag_P.NotchFilter1_C[0] *
                      flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[0] +
                      flexibleDrive_NotchLeadLag_P.NotchFilter1_C[1] *
                      flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[1]) +
    flexibleDrive_NotchLeadLag_P.NotchFilter1_D *
    flexibleDrive_NotchLeadLag_B.LeadComp3;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_NotchFilter1 > flexibleDrive_NotchLeadLag_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    flexibleDrive_NotchLeadLag_B.Saturation =
      flexibleDrive_NotchLeadLag_P.Saturation_UpperSat;
  } else if (rtb_NotchFilter1 < flexibleDrive_NotchLeadLag_P.Saturation_LowerSat)
  {
    /* Saturate: '<Root>/Saturation' */
    flexibleDrive_NotchLeadLag_B.Saturation =
    ...
    /* Saturate: '<Root>/Saturation' */
    flexibleDrive_NotchLeadLag_B.Saturation = rtb_NotchFilter1;
  }
...
void flexibleDrive_NotchLeadLag_derivatives(void)
{
  ...
  _rtXdot->LeadComp2_CSTATE += flexibleDrive_NotchLeadLag_P.LeadComp2_A *
    flexibleDrive_NotchLeadLag_X.LeadComp2_CSTATE;
  _rtXdot->LeadComp2_CSTATE += flexibleDrive_NotchLeadLag_B.LagComp;

  /* Derivatives for TransferFcn: '<Root>/Lead Comp.3' */
  _rtXdot->LeadComp3_CSTATE = 0.0;
  _rtXdot->LeadComp3_CSTATE += flexibleDrive_NotchLeadLag_P.LeadComp3_A *
    flexibleDrive_NotchLeadLag_X.LeadComp3_CSTATE;
  _rtXdot->LeadComp3_CSTATE += flexibleDrive_NotchLeadLag_B.LeadComp2;

  /* Derivatives for TransferFcn: '<Root>/Notch Filter1' */
  _rtXdot->NotchFilter1_CSTATE[0] = 0.0;
  _rtXdot->NotchFilter1_CSTATE[0] +=
    flexibleDrive_NotchLeadLag_P.NotchFilter1_A[0] *
    flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[0];
  _rtXdot->NotchFilter1_CSTATE[1] = 0.0;
  _rtXdot->NotchFilter1_CSTATE[0] +=
    flexibleDrive_NotchLeadLag_P.NotchFilter1_A[1] *
    flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[1];
  _rtXdot->NotchFilter1_CSTATE[1] +=
    flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[0];
  _rtXdot->NotchFilter1_CSTATE[0] += flexibleDrive_NotchLeadLag_B.LeadComp3;
}
...
void flexibleDrive_NotchLeadLag_initialize(void)
{
  ...
  flexibleDrive_NotchLeadLag_X.LeadComp3_CSTATE = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/Notch Filter1' */
  flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[0] = 0.0;
  flexibleDrive_NotchLeadLag_X.NotchFilter1_CSTATE[1] = 0.0;
}
...
RT_MODEL_flexibleDrive_NotchL_T *flexibleDrive_NotchLeadLag(void)
{
  ...
  /* External mode info */
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[0] = (775683436U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[1] = (1455489068U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[2] = (674420727U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[3] = (4238415353U);
  ...
  flexibleDrive_NotchLeadLag_M->Sizes.numBlocks = (26);/* Number of blocks */
  flexibleDrive_NotchLeadLag_M->Sizes.numBlockIO = (11);/* Number of block outputs */
