...
void flexibleDrive_NotchLeadLag_output(void)
{
  ...
  flexibleDrive_NotchLeadLag_B.LeadComp = 0.0;
  flexibleDrive_NotchLeadLag_B.LeadComp +=
    flexibleDrive_NotchLeadLag_P.LeadComp_C *
    flexibleDrive_NotchLeadLag_X.LeadComp_CSTATE;
  flexibleDrive_NotchLeadLag_B.LeadComp +=
    flexibleDrive_NotchLeadLag_P.LeadComp_D *
    flexibleDrive_NotchLeadLag_B.LeadComp1;
...
void flexibleDrive_NotchLeadLag_derivatives(void)
{
  ...
  _rtXdot->LeadComp_CSTATE += flexibleDrive_NotchLeadLag_P.LeadComp_A *
    flexibleDrive_NotchLeadLag_X.LeadComp_CSTATE;
  _rtXdot->LeadComp_CSTATE += flexibleDrive_NotchLeadLag_B.LeadComp1;
  ...
  _rtXdot->NotchFilter_CSTATE[1] +=
    flexibleDrive_NotchLeadLag_X.NotchFilter_CSTATE[0];
  _rtXdot->NotchFilter_CSTATE[0] += flexibleDrive_NotchLeadLag_B.LeadComp;
}
...
void flexibleDrive_NotchLeadLag_initialize(void)
{
  ...
  flexibleDrive_NotchLeadLag_X.LeadComp_CSTATE = 0.0;
...
RT_MODEL_flexibleDrive_NotchL_T *flexibleDrive_NotchLeadLag(void)
{
  ...
  /* External mode info */
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[0] = (3253233750U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[1] = (3508057016U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[2] = (4235277494U);
  flexibleDrive_NotchLeadLag_M->Sizes.checksums[3] = (1976999632U);
