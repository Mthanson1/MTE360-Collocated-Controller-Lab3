...
void flexibleDrive_NotchLead_output(void)
{
  ...
  if (rtmIsMajorTimeStep(flexibleDrive_NotchLead_M)) {
    ...
    /* S-Function Block: flexibleDrive_NotchLead/Plant/Inverse Modulus (inverse_modulus_block) */
    {
      ...
      rtb_InverseModulus = flexibleDrive_NotchLead_B.mmcn +
        flexibleDrive_NotchLead_DW.InverseModulus_Revolutions *
   ...
   *  Sum: '<S2>/Sum'
   */
  flexibleDrive_NotchLead_B.Gain = (look1_binlxpw(rt_remd_snf
    ...
    2000U) - flexibleDrive_NotchLead_B.InverseModulus1) *
  ...
  flexibleDrive_NotchLead_B.LeadComp2 = 0.0;
  flexibleDrive_NotchLead_B.LeadComp2 += flexibleDrive_NotchLead_P.LeadComp2_C *
    flexibleDrive_NotchLead_X.LeadComp2_CSTATE;
  flexibleDrive_NotchLead_B.LeadComp2 += flexibleDrive_NotchLead_P.LeadComp2_D *
    flexibleDrive_NotchLead_B.LeadComp1;

  /* TransferFcn: '<Root>/Notch Filter' */
  rtb_Saturation = (flexibleDrive_NotchLead_P.NotchFilter_C[0] *
    ...
    flexibleDrive_NotchLead_B.LeadComp2;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_Saturation > flexibleDrive_NotchLead_P.Saturation_UpperSat) {
    rtb_Saturation = flexibleDrive_NotchLead_P.Saturation_UpperSat;
  } else if (rtb_Saturation < flexibleDrive_NotchLead_P.Saturation_LowerSat) {
    rtb_Saturation = flexibleDrive_NotchLead_P.Saturation_LowerSat;
  }
...
void flexibleDrive_NotchLead_derivatives(void)
{
  ...
  _rtXdot->LeadComp2_CSTATE += flexibleDrive_NotchLead_P.LeadComp2_A *
    flexibleDrive_NotchLead_X.LeadComp2_CSTATE;
  _rtXdot->LeadComp2_CSTATE += flexibleDrive_NotchLead_B.LeadComp1;
  ...
  _rtXdot->NotchFilter_CSTATE[1] +=
    flexibleDrive_NotchLead_X.NotchFilter_CSTATE[0];
  _rtXdot->NotchFilter_CSTATE[0] += flexibleDrive_NotchLead_B.LeadComp2;
}
...
void flexibleDrive_NotchLead_initialize(void)
{
  ...
  flexibleDrive_NotchLead_X.LeadComp2_CSTATE = 0.0;
...
RT_MODEL_flexibleDrive_NotchL_T *flexibleDrive_NotchLead(void)
{
  ...
  flexibleDrive_NotchLead_M->Sizes.numBlocks = (20);/* Number of blocks */
  flexibleDrive_NotchLead_M->Sizes.numBlockIO = (7);/* Number of block outputs */
